				...
				<div className="mx-auto max-w-4xl px-4 py-6">
					<div className="flex items-center justify-between">
						<div className="flex items-center space-x-3">
							...
							<h1 className="font-bold text-gray-800 text-xl">MyOS</h1>
						</div>
						<Link href="/login">
							...
							<TabsContent value="terms" className="mt-0">
								<div className="prose prose-gray max-w-none space-y-6">
									...
									<section>
										...
										<p className="text-gray-600 leading-relaxed">
											By accessing and using MyOS, you accept and agree to be bound by the terms and
									...
									<section>
										...
										<p className="text-gray-600 leading-relaxed">
											Permission is granted to temporarily use MyOS for personal, non-commercial
										...
										<ul className="ml-4 list-inside list-disc space-y-2 text-gray-600 leading-relaxed">
											...
											<li>attempt to reverse engineer any software contained on MyOS</li>
											<li>
									...
									<section>
										...
										<p className="text-gray-600 leading-relaxed">
											You retain ownership of any content you create, upload, or store using MyOS.
								...
								<div className="prose prose-gray max-w-none space-y-6">
									...
									<section>
										...
										<ul className="ml-4 list-inside list-disc space-y-2 text-gray-600 leading-relaxed">
											...
											<li>Content you create, upload, or store using MyOS</li>
