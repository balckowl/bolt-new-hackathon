								...
								<FormItem>
									...
									<FormControl>
										<Input
											...
											className="w-full rounded-lg border border-gray-300 px-3 py-2 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus-visible:ring-transparent"
										/>
									</FormControl>
									<FormMessage />
								</FormItem>
